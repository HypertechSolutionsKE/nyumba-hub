	    ...
	    <div class="row">
	        ...
	        <div class="property__ribon">For rent</div>
                        	...
                        	<div class="slider__block js-slick-slider">
                          		<div data-slide-rel='0' class="slider__item slider__item--0">
                            		<div class="slider__img">
                            			<img data-lazy="assets/media-demo/properties/277x180/01.jpg" src="assets/img/lazy-image.jpg" alt="">
                            		</div>
                          		</div>
	                          	<div data-slide-rel='1' class="slider__item slider__item--1">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/02.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
	                          	<div data-slide-rel='2' class="slider__item slider__item--2">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/03.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
	                          	<div data-slide-rel='3' class="slider__item slider__item--3">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/04.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
	                          	<div data-slide-rel='4' class="slider__item slider__item--0">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/05.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
	                          	<div data-slide-rel='5' class="slider__item slider__item--1">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/09.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
		                        <div data-slide-rel='6' class="slider__item slider__item--2">
		                            <div class="slider__img">
		                            	<img data-lazy="assets/media-demo/properties/277x180/06.jpg" src="assets/img/lazy-image.jpg" alt="">
		                            </div>
		                        </div>
	                          	<div data-slide-rel='7' class="slider__item slider__item--3">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/07.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
	                          	<div data-slide-rel='8' class="slider__item slider__item--0">
	                            	<div class="slider__img">
	                            		<img data-lazy="assets/media-demo/properties/277x180/08.jpg" src="assets/img/lazy-image.jpg" alt="">
	                            	</div>
	                          	</div>
                        	</div>
		        ...
		        <div class="property__plan">
	              		...
	              		<div data-sr="enter bottom move 80px, scale(0), over 0s" data-animate-end="animate-end" class="worker js-unhide-block vcard worker--list worker--details">
	                		<div class="worker__photo">
	                			<a href="agent_profile.html" class="item-photo item-photo--static">
	                    			...
	                    			<figure class="item-photo__hover"><span class="item-photo__more">View Details</span>
	                    			</figure>
	                    		</a>
	                    	</div>
			                <div class="worker__intro">
			                    ...
			                    <div class="worker__intro-col">
			                      	<div class="social social--worker"><a href="property_details.html#" class="social__item"><i class="fa fa-facebook"></i></a><a href="property_details.html#" class="social__item"><i class="fa fa-linkedin"></i></a><a href="property_details.html#" class="social__item"><i class="fa fa-twitter"></i></a><a href="property_details.html#" class="social__item"><i class="fa fa-google-plus"></i></a>
			                      	</div>
			                    </div>
			                </div>
			                <div class="worker__intro-row">
	              ...
	              <!-- end of block .worker-->
	            <form action="property_details.html#" method="POST" class="form form--flex form--property-agent js-contact-form form--properties">
	                <div class="row">
