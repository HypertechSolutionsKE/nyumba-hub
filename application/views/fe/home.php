<div class="site-wrap js-site-wrap">
  <div class="widget js-widget widget--landing widget--bg">
        ...
        <div class="widget js-widget widget--landing widget--gray">
          <div class="widget__header">
            <h2 class="widget__title"><span class="title-thin">Our</span> Agents</h2>
            <h5 class="widget__headline">Our agents are licensed professionals that specialise in searching, evaluating and negotiating the purchase of property on behalf of the buyer. They will sell you real estate. Insights, tips & how-to guides on selling property and preparing your home or investment property for sale and working to maximise your sale price.</h5>
          </div>
          <div class="widget__content">
            <!-- BEGIN SECTION WORKER INDEX-->
            <div data-sr="enter bottom move 80px, scale(0), over 0s" data-animate-end="animate-end" class="worker js-unhide-block vcard worker--card">
              <div class="worker__photo"><a href="agent_profile.html" class="item-photo item-photo--static">
              ...
              <div class="worker__intro">
                ...
                <div class="worker__post">Realtor, West USA Realty</div><a class="worker__company">
                <img src="<?php echo base_url();?>assets/fe/media-demo/partners/logo-company-proera.png" alt="Pro"/></a><span class="worker__company-name">Pro Era West Realty</span><a class="worker__more">View more details</a>
              </div>
            </div>
            <!-- end of block .worker-->
          </div>
