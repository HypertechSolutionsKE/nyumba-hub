<!-- BEGIN FOOTER-->
                ...
                <div class="footer__wrap">
                  <div class="footer__col footer__col--first">
                    ...
                    <div class="widget js-widget widget--footer">
                      ...
                      <div class="widget__content">
                        <div class="social social--footer"><a href="index.html#" class="social__item"><i class="fa fa-facebook"></i></a><a href="index.html#" class="social__item"><i class="fa fa-twitter"></i></a><a href="index.html#" class="social__item"><i class="fa fa-google-plus"></i></a></div>
                  ...
                  <div class="footer__col footer__col--second">
                    ...
                    <div class="widget js-widget widget--footer">
                      ...
                      <div class="widget__content">
                        ...
                        <form action="index.html#" class="form form--flex form--footer js-parsley">
                          <div class="row">
    ...
    <script src="assets/js/vendor.min.js?v=201603120801"></script>
    <script src="assets/js/demodata.min.js?v=201603120801"></script>
    <script src="assets/js/app.min.js?v=201603120801"></script>
    <script src="assets/js/demo.min.js?v=201603120801"></script>
<!-- inject:ga  -->
