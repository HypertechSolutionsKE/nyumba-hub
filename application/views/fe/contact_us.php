          ...
          <div class="row">
              ...
              <div class="contacts__address">
                <address class="contacts__address-item"><span class="contacts__address-title">NEW YORK</span>
                  ...
                  <dl class="contacts__address-column">
                    ...
                    <dd><a href="contacts.html">jobisdone</a></dd>
                  </dl>
                </address>
              </div>
              <div class="contacts__form">
                <div class="alert alert-info">Attention! This form requires working php server for successful submit!</div>
                <form action="contacts.html#" method="POST" class="form form--flex js-contact-form form--contacts">
                  <div class="row">
            ...
            <div class="contacts__column">
              <div class="contacts__body">
                ...
                <p>Founded in August of 2008 and based in San Francisco, California, RealtySpace is a trusted community marketplace for people to list, discover, and book unique accommodations around<a href="contacts.html#"> the world</a> &mdash; online or from a mobile phone.</p>
                <p>Whether an apartment for a night, a castle for a week, or a villa for a month, RealtySpace connects people to unique travel experiences, at any price point, in more than 190 countries. And with world-class customer service, RealtySpace is the easiest way for people to monetize their extra sp</p>
              </div>
              <div class="contacts__social">
                <div class="social social--worker social--contacts"><span class="contacts__social-title">Our social profiles:</span><a href="contacts.html#" class="social__item"><i class="fa fa-facebook"></i></a><a href="contacts.html#" class="social__item"><i class="fa fa-twitter"></i></a><a href="contacts.html#" class="social__item"><i class="fa fa-google-plus"></i></a></div>
              </div>
            </div>
          </div>
        </div>
