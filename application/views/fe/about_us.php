<div class="center">
    ...
    <div class="row">
            ...
            <div class="widget__content">
              <article class="article article--list article--details">
                <div class="article__body">
                  ...
                  </p><img src="<?php echo base_url();?>assets/fe/media-demo/properties/870x480/02.jpg" alt="">
                ...
                <div class="article__footer">
                  <div class="social social--article"><span>Share this post:</span><a href="page.html#" class="social__item"><i class="fa fa-facebook"></i></a><a href="page.html#" class="social__item"><i class="fa fa-twitter"></i></a><a href="page.html#" class="social__item"><i class="fa fa-google-plus"></i></a></div>
                </div>
              </article>
            </div>
          </div>
      ...
      <div class="sidebar">
        <div class="widget js-widget widget--sidebar widget--dark">
          ...
          <div class="widget__content">
            <div class="listing listing--sidebar">
              ...
              <div class="listing__item">
                <div class="properties properties--sidebar">
                  <div class="properties__thumb"><a href="property_details.html" class="item-photo item-photo--static">
        ...
        <div class="widget js-widget widget--sidebar widget--dark">
          <div class="widget__header">
            <h2 class="widget__title" style="padding-top: 20px">Our agents</h2>
          ...
          <div class="widget__content">
            <div class="listing listing--sidebar">
                ...
                <div>
                    <div class="worker__photo">
                        <a href="agent_profile.html" class="item-photo item-photo--static">
                            <img src="<?php echo base_url();?>assets/fe/media-demo/workers/worker-1.jpg" alt="Christopher Pakulla" class="photo"/>
                        </a>
                    </div>
              ...
              <div class="listing__item">
                <div>
                  <div class="worker__photo">
                        <a class="item-photo item-photo--static">
                            <img src="<?php echo base_url();?>assets/fe/media-demo/workers/worker-2.jpg" alt="Lisa Wemert" class="photo"/>
                        </a>
                    </div>
              ...
              <div class="listing__item">
                <div>
                  <div class="worker__photo">
                        <a class="item-photo item-photo--static">
                            <img src="<?php echo base_url();?>assets/fe/media-demo/workers/worker-3.jpg" alt="Mariusz Ciesla" class="photo"/>
                        </a>
                    </div>
