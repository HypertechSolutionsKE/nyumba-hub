        ...
        <div class="page-content">
            ...
            <?php if (!isset($property)): ?>
                <div class="row">
                    <div class="col-md-9">
                        <form class="validate" method="post" role="form" id="frm_newpropertyfeatures" name="frm_newpropertyfeatures" onsubmit="return save_new_property_features();" enctype="multipart/form-data">
                            ...
                            <div class="panel panel-danger">
                                ...
                                <div class="panel-body">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <li class="active"><a href="<?php echo base_url();?>be/properties/add_features">Step 2: Property Features</a></li>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="bedrooms" name="bedrooms" class="form-control" value="<?php if(false !== $this->session->userdata('bedrooms')){echo $this->session->userdata('bedrooms');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->bathrooms == 1): ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="bathrooms" name="bathrooms" class="form-control" value="<?php if(false !== $this->session->userdata('bathrooms')){echo $this->session->userdata('bathrooms');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->total_rooms == 1): ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="total_rooms" name="total_rooms" class="form-control" value="<?php if(false !== $this->session->userdata('total_rooms')){echo $this->session->userdata('total_rooms');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->living_area == 1): ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="living_area" name="living_area" class="form-control" value="<?php if(false !== $this->session->userdata('living_area')){echo $this->session->userdata('living_area');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="floor" name="floor" class="form-control" value="<?php if(false !== $this->session->userdata('floor')){echo $this->session->userdata('floor');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->total_floors == 1): ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="total_floors" name="total_floors" class="form-control" value="<?php if(false !== $this->session->userdata('total_floors')){echo $this->session->userdata('total_floors');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->land_size == 1): ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="land_size" name="land_size" class="form-control" value="<?php if(false !== $this->session->userdata('land_size')){echo $this->session->userdata('land_size');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->building_size == 1): ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" id="building_size" name="building_size" class="form-control" value="<?php if(false !== $this->session->userdata('building_size')){echo $this->session->userdata('building_size');}  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-7">
                                                ...
                                                <textarea id="description" name="description" class="form-control"><?php if(false !== $this->session->userdata('description')){echo $this->session->userdata('description');}  ?></textarea>
                                            </div>
                                            <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-7">
                                                ...
                                                <input type="text" id="available_from" name="available_from" class="form-control" value="<?php if(false !== $this->session->userdata('available_from')){echo $this->session->userdata('available_from');}  ?>">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-7">
                                                ...
                                                <input type="text" id="build_year" name="build_year" class="form-control" value="<?php if(false !== $this->session->userdata('build_year')){echo $this->session->userdata('build_year');}  ?>">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-7">
                                                ...
                                                <input type="text" id="car_spaces" name="car_spaces" class="form-control" value="<?php if(false !== $this->session->userdata('car_spaces')){echo $this->session->userdata('car_spaces');}  ?>">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                ...
                                                <select data-placeholder="Please Choose..." class="clear-results" tabindex="2" id="fully_furnished" name="fully_furnished">
                                                    <option value=""></option>
                                                    <option value="Yes" <?php if(false !== $this->session->userdata('fully_furnished')){if($this->session->userdata('fully_furnished') == 'Yes'){echo 'selected';}}  ?>>Yes</option>
                                                    <option value="No" <?php if(false !== $this->session->userdata('fully_furnished')){if($this->session->userdata('fully_furnished') == 'No'){echo 'selected';}}  ?>>No</option>                               
                                                </select> 
                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="property_feature_id[]" value="<?php echo $row2->property_feature_id; ?>"
                                                                        ...
                                                                        ?>
                                                                    ><?php echo $row2->property_feature_name; ?>
                                                                </label>
                                                            </div>                          
                                                        <?php endif; ?>
                                                    <?php endforeach; ?>                    
            ...
            <?php else: ?>
                <?php foreach ($property as $row2): ?>
                    <div class="row">
                        <div class="col-md-9">
                            <form class="validate" method="post" role="form" id="frm_newpropertyfeatures" name="frm_newpropertyfeatures" onsubmit="return update_property_features();" enctype="multipart/form-data">
                                ...
                                <div class="panel panel-danger">
                                    ...
                                    <div class="panel-body">
                                        <ul class="nav nav-pills nav-justified">
                                            ...
                                            <li class="active"><a href="<?php echo base_url();?>be/properties/edit_features/<?php echo $row2->property_id; ?>">Step 2: Property Features</a></li>
                                            ...
                                            <?php if ($row->bedrooms == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Bedrooms *&nbsp;&nbsp;<a data-placement="top" class="tip" title="How many bedrooms does your property have?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="bedrooms" name="bedrooms" class="form-control" value="<?php echo $row2->bedrooms;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            <?php if ($row->bathrooms == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Bathrooms *&nbsp;&nbsp;<a data-placement="top" class="tip" title="How many bathrooms does your property have?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="bathrooms" name="bathrooms" class="form-control" value="<?php echo $row2->bathrooms;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            <?php if ($row->total_rooms == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Total Rooms&nbsp;&nbsp;<a data-placement="top" class="tip" title="How many rooms in total does your property have?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="total_rooms" name="total_rooms" class="form-control" value="<?php echo $row2->total_rooms;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            <?php if ($row->living_area == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Living Area (m<sup>2</sup>) *&nbsp;&nbsp;<a data-placement="top" class="tip" title="How large are all rooms of your property in total?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="living_area" name="living_area" class="form-control" value="<?php echo $row2->living_area;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if ($row->total_floors == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Total Floors&nbsp;&nbsp;<a data-placement="top" class="tip" title="How many floors does your property have in total?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="total_floors" name="total_floors" class="form-control" value="<?php echo $row2->total_floors;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            <?php if ($row->land_size == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Land Size (m<sup>2</sup>) *&nbsp;&nbsp;<a data-placement="top" class="tip" title="How large is your property size?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="land_size" name="land_size" class="form-control" value="<?php echo $row2->land_size;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            <?php if ($row->building_size == 1): ?>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-7">
                                                            <label>Building Size (m<sup>2</sup>) *&nbsp;&nbsp;<a data-placement="top" class="tip" title="How large is your property building size?"><i class="icon-question2"></i></a></label>
                                                            <input type="text" id="building_size" name="building_size" class="form-control" value="<?php echo $row2->building_size;  ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    <label>Build (Year)&nbsp;&nbsp;<a data-placement="top" class="tip" title="When was the property built?"><i class="icon-question2"></i></a></label>
                                                    <input type="text" id="build_year" name="build_year" class="form-control" value="<?php echo $row2->build_year;  ?>">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    <label>Car Spaces&nbsp;&nbsp;<a data-placement="top" class="tip" title="How many parking slots / car spaces belong to your property?    "><i class="icon-question2"></i></a></label>
                                                    <input type="text" id="car_spaces" name="car_spaces" class="form-control" value="<?php echo $row2->car_spaces;  ?>">
                                                </div>
