...
<html lang="en">
	<head>
		...
		<title>Set System Administrator - NyumbaHub</title>
	...
	<div class="register-wrapper">
    	<form class="set-system-admin-form" action="<?php echo base_url();?>be/auth/register" method="post" role="form" enctype="multipart/form-data">
			<div class="popup-header">
				...
				<span class="text-semibold">Set System Administrator</span>
			</div>
			<div class="well">
				...
				<div class="row form-actions">
					<div class="col-md-12">
						<button type="submit" class="btn btn-info pull-right"><i class="icon-lock3"></i> Register</button>
					</div>
				</div>
			</div>
    	</form>
    ...
    <div class="footer clearfix">
        <div class="pull-left">Copyright &copy; <?php echo date('Y'); ?> - All Rights Reserved - <a href="#">NyumbaHub</a></div>
    </div>
    <!-- /footer -->
